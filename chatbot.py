...
def retriever_tool(query: str) -> str:
    """
    This tool searches and returns the information from the 2024 Corvette Owner's Manual document.
    """

    docs = retriever.invoke(query)

    if not docs:
        return "I found no relevant information in the 2024 Corvette Owner's Manual document."
...
system_prompt = """
You are an intelligent AI assistant who answers questions about the 2024 Chevrolet Corvette based on the PDF document loaded into your knowledge base.
Use the retriever tool available to answer questions about the Corvette. You can make multiple calls if needed.
